 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class SingleSelectionListUpButtonListener extends SelectionAdapter {
     ...
     * 
     */
    public SingleSelectionListUpButtonListener(final List list) {
        super();
        this.list = list;
    }
    ...
    protected void moveUp(final SelectionEvent e){
